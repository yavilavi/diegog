            ...
            <div class="col-sm-9 col-md-18 main">
                ...
                <div class="row gestor-activos">
                    <div class="col-md-12">
                        ...
                        $cantidad_actt=count(entradas ::Obtener_activosordenados(Conexion::obtener_conexion()));
                        if($cantidad_actt>0){
                            ?>
                        ...
                        Conexion::abrir_conexion();
                        $array_activos= entradas ::Obtener_activosordenados(Conexion::obtener_conexion());
                        ...
                        <?php
                            ...
                            ?>
                        <h3 class="text-center">No hay Pre-Inscripciones activas</h3>
                        <br>
                        <br>
                        <?php
                        }
