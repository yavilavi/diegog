...
if (isset($_POST['g'])) {
    ...
    $ext = pathinfo($_FILES['file-7']['name']);
    $ext = $ext['extension'];
    // renombrar el archivo para que sea único al usuaario asignando la cédula
    $fileName = 'curso_crt_'.$_POST['documento'].'.'.$ext;

    //definir ruta a dónde se va a subir y concatenar el nombre del archivo
    $target = 'archivos/' . $fileName;
    //subir archivo
    move_uploaded_file($_FILES['file-7']['tmp_name'], $target);

    if ($_POST['modalidad'] === 'Rl' || $_POST['modalidad'] === 'Ie') {
        // obtener extensión del archivo subido
        $ext = pathinfo($_FILES['filep']['name']);
        $ext = $ext['extension'];
        // renombrar el archivo para que sea único al usuaario asignando la cédula
        $certLaboral = 'laboral_crt_'.$_POST['documento'].'.'.$ext;

        //definir ruta a dónde se va a subir y concatenar el nombre del archivo
        $target = 'archivos/' . $certLaboral;
        //subir archivo
        move_uploaded_file($_FILES['file-7']['tmp_name'], $certLaboral);
    } else {
        $img2 = null;
    }

    $vali->setImagen($fileName); //se guarda en la bd solo el nombre del archivo
    $vali->setCertificado($certLaboral); //se guarda en la bd solo el nombre del archivo
            ...
            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                ...
                <div class="conetenedorl">
                    ...
                    <div class="input-contenedor">
                        ...
                        <input type="password" placeholder="contraseña" class="login" name="password" id="password"
                               requiered>
                    </div>
...
<form id="msform" class="formulario" onsubmit="return validar()" role="form" method="post" enctype="multipart/form-data"
    ...
    <fieldset>
        ...
        <input type="file" name="file-7" id="file-7" class="inputfile inputfile-7"
               data-multiple-caption="{count} archivos seleccionados" multiple required/>
        <label for="file-7">
    ...
    <fieldset>
        ...
        <br
        <div class="datos">
            <input type="file" name="filep" id="filep" class="inputfile inputfile-7"
  ...
  "/>
    ...
    <fieldset>
        ...
        <div class="galeria-work">
            ...
            <div class="cont-work reconocimientolaboral" id="reconocimientolaboral" style="display: none;">
                ...
                <div class="textos-work">
                    ...
                    <p>Para optar a la modalidad el estudiante deberá presentar una certificación laboral,
                        en la cual consten las funciones o competencias que desarrolla, y el tiempo de vinculación
                        laboral
            ...
            <div class="cont-work participacióneninvestigación" id="participacióneninvestigación"
                 style="display: none;">
                <div class="img-work">
                    <div class="textos">
                ...
                <div class="textos-work">
                    <br>
                    <br>
                    <p>Se refiere a productos reconocidos por Colciencias, desarrollados en procesos de
                        investigación.</p>
                    <h4 class="hcuatro">Parágrafo 1:</h4>
            ...
            <div class="cont-work seminariodeprofundización" id="seminariodeprofundización" style="display: none;">
                ...
                <div class="textos-work">
                    ...
                    <p>Para aprobar el seminario se requieren dos condiciones: 1) una nota mínima de
                        ...
                        El estudiante debe cumplir con la asistencia mínimo del 90% de las horas totales del
                        seminario.</p>
                    <h4 class="hcuatro">Parágrafo 4:</h4>
                    <p>Cuando el seminario (curso o diplomado) sea realizado en una institución reconocida
                        por el Ministerio de Educación Nacional este debe tener una duración mínima de 64 horas
                        presenciales,
                        en un tema relacionado con el objeto de formación del programa, haber sido cursado durante los
                        doce
                        meses anteriores a la solicitud de reconocimiento y presentar el informe final, el cual será
                        evaluado
            ...
            <div class="cont-work proyectodegrado" style="display: none;" id="proyectodegrado">
                ...
                <div class="textos-work">
                    ...
                    <p>En caso de excluir a un estudiante del grupo, tanto el docente asesor como los estudiantes
                        deben estar de acuerdo con dicha decisión, e informar del cambio al consejo de facultad por
                        medio
                        de una carta. </p>
                    <h4 class="hcuatro">Parágrafo 5:</h4>
                    <p>Los proyectos de grado deben ser excluidos del ciclo complementario de los programas
                        ...
                        tecnológico desee realizar una monografía, este lo puede hacer solicitando en una carta al
                        consejo
                        de facultad expresando la motivación y una aprobación firmada del docente responsable de la
                        asesoría.</p>
                </div>
